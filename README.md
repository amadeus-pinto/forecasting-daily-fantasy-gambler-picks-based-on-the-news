...
##Model factors
  Follow the links below to view pair distributions of dependent ("percent_own") and independent variables of LeBron James observations.  
